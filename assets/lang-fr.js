...
window.translationsFR = {
  ...
  "cuisine.caption.bouilloire.30": "ouverture remplissage eau",
  "cuisine.caption.cafetiere.10": "Bouton marche arret",
  "cuisine.caption.cafetiere.20": "ouverture pour filtre",
  "cuisine.caption.cafetiere.30": "ouverture reserve d'eau",
  "cuisine.caption.grille_pain.30": "tirroir à miettes.",
  "cuisine.caption.machine_a_cafe_senseo.10": "Capsule Senséo exclusivement",
  "cuisine.caption.machine_a_laver.10": "Panneau de commande Reglage cycle, allumage, démarrage",
  "cuisine.caption.machine_a_laver.20": "Attention petite musique de fin d'activitée",
  "cuisine.caption.mini_refrigerateur.20": "marche et réglage température",
  "cuisine.caption.plaque_cuisson_vitro_ceramique.20": "1> choix de la plaque (defilement) 2> régle la puissance de chauffe (1 à 9) 3> Si la clef est allumé = sécurité active (appuyer 5 secondes pour déverrouiller )",
  "cuisine.li.bouilloire": "Bouilloire",
  "cuisine.li.cafetiere": "Cafetière",
  "cuisine.li.cafetière": "Cafetière",
  "cuisine.li.congelateur": "Congélateur",
  "cuisine.li.congélateur": "Congélateur",
  "cuisine.li.four": "Four",
  "cuisine.li.grille_pain": "Grille-pain",
  "cuisine.li.grillepain": "Grille-pain",
  "cuisine.li.lave_vaisselle": "Lave-vaisselle",
  "cuisine.li.lavevaisselle": "Lave-vaisselle",
  "cuisine.li.machine_a_cafe_senseo": "Machine à café Senseo",
  "cuisine.li.machine_a_laver": "Machine à laver",
  "cuisine.li.machine_à_café_senseo": "Machine à café Senseo",
  "cuisine.li.machine_à_laver": "Machine à laver",
  "cuisine.li.mini_refrigerateur": "Mini réfrigérateur",
  "cuisine.li.mini_réfrigérateur": "Mini réfrigérateur",
  "cuisine.li.plaque_cuisson_vitro_ceramique": "Plaque cuisson vitro céramique",
  ...
  "placard_bleu.caption.equipement_bebe.10": "Baignoire",
  "placard_bleu.caption.equipement_bebe.20": "Baignoire",
  "placard_bleu.caption.lit_parapluie_bebe.10": "dépliage du lit parapluie",
  "placard_bleu.caption.lit_parapluie_bebe.20": "dépliage du lit parapluie",
  "placard_bleu.li.box_fibre_orange_wi_fi": "Box fibre Orange Wi‑Fi",
  "placard_bleu.li.box_fibre_orange_wifi": "Box fibre Orange Wi‑Fi",
  "placard_bleu.li.chaise_haute": "Chaise haute",
  "placard_bleu.li.equipement_bebe": "Équipement Bébé",
  "placard_bleu.li.lit_parapluie_bebe": "Lit parapluie bébé",
  "placard_bleu.li.lit_parapluie_bébé": "Lit parapluie bébé",
  "placard_bleu.li.plancha": "Plancha",
  "placard_bleu.li.service_a_raclette": "Service à raclette",
  "placard_bleu.li.service_à_raclette": "Service à raclette",
  "placard_bleu.li.table_a_langer": "Table à langer",
  ...
  "salle_a_manger.caption.climatisation.10": "Vue d'ensemble de la climatisation",
  "salle_a_manger.caption.climatisation.20": "Vue d'ensemble de la climatisation",
  "salle_a_manger.caption.climatisation.30": "Vue d'ensemble de la climatisation",
  "salle_a_manger.li.climatisation": "Climatisation",
  "salle_a_manger.li.radiateur": "Radiateur",
  "salle_d_eau.li.douche": "Douche",
  "salle_d_eau.li.miroir_lumineux": "Miroir lumineux",
  "salle_d_eau.li.radiateur_sdb": "Radiateur sdb",
  ...
  "salon.caption.canape_convertible.10": "Canapé convertible Rapido larguer 140.",
  "salon.caption.enceinte_bluetooth.10": "l'appairage se fait en pressant le bouton marche deux secondes. Ensuite, sur votre smartphone par exemple sélectionnez Bluetooth: \"UB+ Eupho E2\"",
  "salon.caption.enceinte_bluetooth.20": "Recharge USB C",
  "salon.li.alexa": "Alexa",
  "salon.li.box_canal": "Box Canal+",
  "salon.li.box_tv_orange": "Box TV Orange",
  "salon.li.canape_convertible": "Canapé convertible",
  "salon.li.canapé_convertible": "Canapé convertible",
  "salon.li.enceinte_bluetooth": "Enceinte bluetooth",
  "salon.li.jeux_de_societe": "Jeux de société",
  "salon.li.jeux_de_société": "Jeux de société",
  "salon.li.programmes_tv_canal": "Programmes TV Canal+",
  "salon.li.tv_salon": "TV Salon",
  "salon.title": "\uD83D\uDECB️ Salon",
  "terrasse.caption.baie_vitree.10": "Loquet central Vertical=Fermé, Horizontal=Ouvert",
  "terrasse.caption.baie_vitree.20": "Loquet latéral tirer puis tourner: Vertical=Fermé, Horizontal=Ouvert",
  "terrasse.caption.barbecue.10": "Attention aux éléments trés chaud. Pensez à nettoyer aprés utilisation Merci.",
  "terrasse.caption.plancha.10": "Attention aux éléments trés chaud. Pensez à nettoyer aprés utilisation Merci.",
  "terrasse.caption.robinet_jardiniere.10": "Merci de ne pas toucher !",
  "terrasse.caption.robinet_jardiniere.20": "Merci de ne pas toucher !",
  "terrasse.caption.robinet_jardiniere.30": "Merci de ne pas toucher !",
  "terrasse.caption.robinet_jardiniere.40": "Merci de ne pas toucher !",
  "terrasse.caption.store_banne.10": "Store ouvert / Store refermé.",
  "terrasse.caption.store_banne.20": "Télécomande et commande murale. Un dispositif de sécurité, en cas de vent violent replie automatiquement le store et ne permet son redeploiement qu'après 30 minutes. ATTENTION Ce dispositif ne protége pas des rafales. Veillez à replier le store systématiquement lorsque vous sortez ou percevez un risque de vent plus important.",
  "terrasse.caption.volets_roulants.10": "Fermé",
  "terrasse.caption.volets_roulants.20": "Ouvert",
  "terrasse.caption.volets_roulants.30": "Télécommande: ^ = monter, v = descendre, my= arret. ATTENTION assurez-vous que rien n'entrave la descente du store !",
  "terrasse.li.baie_vitree": "Baie vitrée",
  "terrasse.li.baie_vitrée": "Baie vitrée",
  "terrasse.li.barbecue": "Barbecue",
  "terrasse.li.plancha": "Plancha",
  "terrasse.li.robinet_jardiniere": "Robinet jardinière",
  "terrasse.li.robinet_jardinière": "Robinet jardinière",
  "terrasse.li.seche_linge": "Sèche linge",
  ...
  "wc.caption.armoire_electrique.10": "En cas de panne de courant ou aprés un orage, si certains équipements de l'appartement ne fonctionnent pas, vous pouvez vérifier en prenant toutes les précautions nécessaire, que le disjoncteur général ou les petits disjonteurs n'ont pas sauté. Essayez de les remettre, mais ne jamais insister s'ils ne tiennent pas!",
  "wc.li.armoire_electrique": "Armoire électrique",
